...
public class StudentDriver
{
	...
	public void student()
	{
		...
		try
		{
			...
			StudentValidation.Exception1(st3);
			d1.setfirstName(st3);
			...
			st3=sc.nextLine();
			StudentValidation.Exception1(st3);
			d1.addr.setline1(st3);
			System.out.print("LINE 2  : ");
			st3=sc.nextLine();
			StudentValidation.Exception1(st3);
			d1.addr.setline2(st3);
			...
			st3=sc.nextLine();
			StudentValidation.Exception1(st3);
			d1.addr.setstate(st3);
			System.out.print("PinCode : ");
			st3=sc.nextLine();
			StudentValidation.Exception1(st3);
			d1.addr.setpinCode(Integer.parseInt(st3));
			System.out.print("\nE-Mail : ");
			st3=sc.nextLine();
			StudentValidation.Exception1(st3);
			d1.seteMail(st3);
	...
	public static void main(String [] args)
	{
		...
		StudentDriver r1=new StudentDriver();
		r1.student();
	}
